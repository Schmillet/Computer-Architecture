...
main:	#initialization
 ...
 #main merge loop
loop_1:
		bgt $s6, 13, exit_1 		#while loop conditions
		bgt $s7, 13, exit_1
...
loop_2:
		beq $s6, 16, exit_2			#Exit loop if list1 is empty
...
loop_3:
		beq $s7, 16, exit_3			#Exit loop if list2 is empty
...
exit_3:
		sub $s4, $s4, 32			#Sets the address for combined_list back to the front
